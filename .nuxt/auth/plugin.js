...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/api/users/login","method":"post","propertyName":"token"},"logout":{"url":"/api/users/logout","method":"post"},"user":{"url":"/api/users/me","method":"get","propertyName":"user"}},"_name":"local"}))
