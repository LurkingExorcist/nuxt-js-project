...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admins.vue?vue&type=template&id=425ca26e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-layout',{attrs:{"column":"","justify-center":"","align-center":""}},[_c('v-flex',{attrs:{"xs12":"","sm8":"","md6":""}},[_c('v-card',[_c('v-card-title',{staticClass:"headline"},[_vm._v("\n        Администрация\n        "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"text":""},on:{"click":_vm.create}},[_vm._v("\n          Создать\n        ")])],1),_vm._v(" "),_c('v-card-text',[_c('v-data-table',{attrs:{"headers":_vm.headers,"items":_vm.items,"multi-sort":""},scopedSlots:_vm._u([{key:"item.role",fn:function(ref){
var item = ref.item;
return [_vm._v("\n          "+_vm._s(_vm.roles.find(function (r) { return r.value === item.role; }).text)+"\n        ")]}},{key:"item.controls",fn:function(ref){
var item = ref.item;
return [_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){return _vm.edit(item)}}},[_c('v-icon',[_vm._v("mdi-pencil")])],1),_vm._v(" "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){return _vm.remove(item)}}},[_c('v-icon',[_vm._v("mdi-delete")])],1)]}}])})],1)],1),_vm._v(" "),_c('v-dialog',{attrs:{"max-width":"505"},model:{value:(_vm.editModal),callback:function ($$v) {_vm.editModal=$$v},expression:"editModal"}},[_c('v-card',{staticClass:"edit-modal"},[_c('v-card-title',{staticClass:"headline"},[_vm._v("\n          "+_vm._s(_vm.modalTitle)+"\n          "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"green darken-1","text":""},on:{"click":_vm.save}},[_vm._v("\n            Сохранить\n          ")])],1),_vm._v(" "),_c('v-card-text',[_c('v-text-field',{attrs:{"label":"Фамилия"},model:{value:(_vm.edititingItem.last_name),callback:function ($$v) {_vm.$set(_vm.edititingItem, "last_name", $$v)},expression:"edititingItem.last_name"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Имя"},model:{value:(_vm.edititingItem.name),callback:function ($$v) {_vm.$set(_vm.edititingItem, "name", $$v)},expression:"edititingItem.name"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Отчество"},model:{value:(_vm.edititingItem.patronymic),callback:function ($$v) {_vm.$set(_vm.edititingItem, "patronymic", $$v)},expression:"edititingItem.patronymic"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Номер телефона"},model:{value:(_vm.edititingItem.phone_number),callback:function ($$v) {_vm.$set(_vm.edititingItem, "phone_number", $$v)},expression:"edititingItem.phone_number"}}),_vm._v(" "),_c('v-text-field',{attrs:{"label":"Email"},model:{value:(_vm.edititingItem.email),callback:function ($$v) {_vm.$set(_vm.edititingItem, "email", $$v)},expression:"edititingItem.email"}}),_vm._v(" "),_c('v-text-field',{attrs:{"type":"password","label":"Пароль"},model:{value:(_vm.edititingItem.password),callback:function ($$v) {_vm.$set(_vm.edititingItem, "password", $$v)},expression:"edititingItem.password"}}),_vm._v(" "),_c('v-select',{attrs:{"items":_vm.roles,"label":"Должность"},model:{value:(_vm.edititingItem.role),callback:function ($$v) {_vm.$set(_vm.edititingItem, "role", $$v)},expression:"edititingItem.role"}})],1)],1)],1),_vm._v(" "),_c('v-snackbar',{attrs:{"color":_vm.alertColor},scopedSlots:_vm._u([{key:"action",fn:function(ref){
var attrs = ref.attrs;
...
// CONCATENATED MODULE: ./pages/admins.vue?vue&type=template&id=425ca26e&

// EXTERNAL MODULE: external "qs"
var external_qs_ = __webpack_require__(128);
var external_qs_default = /*#__PURE__*/__webpack_require__.n(external_qs_);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admins.vue?vue&type=script&lang=js&
//
//
//
//
  ...
  methods: {
    ...
    async fetch() {
      try {
        const {
          data
        } = await this.$axios.get(`/api/${this.table}/list?${external_qs_default.a.stringify(this.query)}`);
        this.items = data;
...
// CONCATENATED MODULE: ./pages/admins.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_adminsvue_type_script_lang_js_ = (adminsvue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./pages/admins.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_adminsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
installComponents_default()(component, {VBtn: VBtn["a" /* default */],VCard: VCard["a" /* default */],VCardText: components_VCard["b" /* VCardText */],VCardTitle: components_VCard["c" /* VCardTitle */],VDataTable: VDataTable["a" /* default */],VDialog: VDialog["a" /* default */],VFlex: VFlex["a" /* default */],VIcon: VIcon["a" /* default */],VLayout: VLayout["a" /* default */],VSelect: VSelect["a" /* default */],VSnackbar: VSnackbar["a" /* default */],VSpacer: VSpacer["a" /* default */],VTextField: VTextField["a" /* default */]})
